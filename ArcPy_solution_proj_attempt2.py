...
class vecMetadata:
    ...
    def getWorkspace(self):
        ...
        while True:
            arcpy.env.workspace = (r"C:\OpenCalgary_project\OpenCalgary_shapes_test")
    ...
    def getVecdata (self):
        ...
        for fc in self.fcs:
            ...
            proj_outfc = os.path.join(r"C:\OpenCalgary_project\Opencalgary_projectedshapes", os.path.splitext(fc)[0])
            arcpy.Project_management(fc, proj_outfc, sr)
...
##                poly_outfc = os.path.join(r"C:\OpenCalgary_project\OpenCalgary_polygons", os.path.splitext(fc)[0])
##                arcpy.CopyFeatures_management(fc, poly_outfc)
##
##            if desc.shapeType == "Point":
##                point_outfc = os.path.join(r"C:\OpenCalgary_project\OpenCalgary_points", os.path.splitext(fc)[0])
##                arcpy.CopyFeatures_management(fc, point_outfc)
##
##            if desc.shapeType == "Polyline":
##                polyline_outfc = os.path.join(r"C:\OpenCalgary_project\OpenCalgary_polylines", os.path.splitext(fc)[0])
##                arcpy.CopyFeatures_management(fc, polyline_outfc)
##
##            if desc.shapeType == "Multipoint":
##                multipoint_outfc = os.path.join(r"C:\OpenCalgary_project\OpenCalgary_multipoint", os.path.splitext(fc)[0])
